...
class LessonDetailsPage extends StatelessWidget {
  ...
  const LessonDetailsPage({Key? key, required this.endPoint, required this.subjectName}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<PdfModel?>(
        future: getPdfs(),
        builder: (context, AsyncSnapshot<PdfModel?> snapshot) {
